		...
		>
			<div className={lectureStyles.lecture_container}>
				<div className={lectureStyles.lecture_heading}>
					<h1>Next lectures</h1>
					<Link href="/">
						<a className={lectureStyles.all_lectures}>All lectures</a>
					</Link>
				</div>
				<div className={lectureStyles.lecture_names}>
						...
						<div className={lectureStyles.lecture_info}>
							<div className={lectureStyles.lecture_date}>
								...
								<div className={lectureStyles.lecture_more_date}>
									<div className={lectureStyles.lecture_monty}>
										December 2021
									</div>
							...
							<div className={lectureStyles.lecture_description}>
								<div className={lectureStyles.lecture_tags}>
									...
									<div className={lectureStyles.tag}>
								...
								<Link href="/news/science">
									<a className={lectureStyles.lecture_title_p}>
										...
										<div className={lectureStyles.p_container}>
											<p className={lectureStyles.styled_p}>
												After twenty-five years of teaching, Ruder published a
												heavily illustrated book capturing his ideas, methods
												and approach. The book, Typographie: A Manual for
												Design.
											</p>
										</div>
									</a>
							...
							<div className={lectureStyles.lecture_add_info}>
								<div className={lectureStyles.lecture_info_1}>
									<div className={lectureStyles.lecture_time_gmt}>
										Starts at 19:00
									</div>
									<div className={lectureStyles.lecture_address}>
										Address: Shevchenko street 13B, building 3, room 5.11
									</div>
								</div>
							</div>
						</div>
							...
							<div className={lectureStyles.lecture_description}>
								...
								<Link href="/news/science">
									<a className={lectureStyles.lecture_title_p}>
										...
										<div className={lectureStyles.p_container}>
											<p className={lectureStyles.styled_p}>
												In 1928, the year he turned 26, the German-born
												calligrapher and typographer Jan Tschichold (1902-74)
												published his landmark book Die Neue Typographie (The
												New Typography).
											</p>
										</div>
									</a>
							...
							<div className={lectureStyles.lecture_description}>
								...
								<Link href="/news/science">
									<a className={lectureStyles.lecture_title_p}>
										...
										<div className={lectureStyles.p_container}>
											<p className={lectureStyles.styled_p}>
												The international creation of typefaces after 1950 was
												decisively influenced by the Swiss type designer Adrian
												Frutiger. His Univers typeface and the machine-readable
												font OCR-B, which was adopted as an ISO standard, are
												milestones, as is his type for the Paris airports, which
												set new standards for signage types and evolved into the
												Frutiger typeface.
											</p>
										</div>
									</a>
					...
					<div className={lectureStyles.lecture_start}></div>
				</div>
			</div>
		</motion.div>
	);
